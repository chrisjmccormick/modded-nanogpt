import uuid
run_id = f"12-10 HAMuon Only - {str(uuid.uuid4())[0:5]}"
    ...
    def step(self):
        ...
        for group, info in zip(self.param_groups, group_infos):
            ...
            if params[module_idx].label == 'attn':
                ...
                # Reshape attn params to individual heads: [3072, 768] -> [24, 128, 768] (6 heads * 4 QKVO)
                updated_grads = updated_grads.view(24 * grad_shape[0], grad_shape[1] // 24, grad_shape[2])
            ...
            if "second_momentum_buffer" not in group:                
                if is_gate or is_attn:
                    # Gates and attn heads have length-768 vectors as rows, reduce along dim -1
            ...
            # Attn heads are [128, 768] after reshape - each row is a length-768 basis vector, reduce along dim -1
            red_dim = -1 if (is_attn or is_gate or param_shape[-2] >= param_shape[-1]) else -2
